<?php
/**
* robingreen.house functions and definitions
...
function robingreenhouse_scripts() {

    // load Bootstrap CSS v5.1
    wp_enqueue_style( 'robingreenhouse-bootstrap-css', THEME_DIR_URI . '/includes/css/bootstrap.min.css');

    // load website CSS, versioned
    wp_enqueue_style( 'robingreenhouse-css', THEME_DIR_URI . '/assets/css/style.css', [], filemtime( get_stylesheet_directory() . '/assets/css/style.css') );

	// load Bootstrap JS v5.1
	wp_enqueue_script( 'robingreenhouse-bootstrap-js', THEME_DIR_URI . '/includes/js/bootstrap.min.js', array('jquery') );
}
add_action( 'wp_enqueue_scripts', 'robingreenhouse_scripts' );
...
/* Register menus */
if ( ! function_exists( 'robingreenhouse_setup' ) ) :
	function robingreenhouse_setup() {

    register_nav_menus( array(
        'primary' => __( 'Primary Menu', 'robingreenhouse' ),
        'footer'  => __( 'Footer Menu', 'robingreenhouse' ),
    ) );
...
add_action( 'after_setup_theme', 'robingreenhouse_setup');
